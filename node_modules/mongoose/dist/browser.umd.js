 ...
 * ignore
 */
function(t,e,r){if(null==e)return;var a=Object.keys(e),u=void 0,c=void 0,l=void 0,f=void 0,h=void 0;if(a.length&&a[0].startsWith("$")){if(e.$push)for(u in e.$push){var p=r.path(u);e.$push[u]&&p&&p.$isMongooseDocumentArray&&p.schema.options.timestamps&&(f=p.schema.options.timestamps,c=i(f,"createdAt"),l=i(f,"updatedAt"),e.$push[u].$each?e.$push[u].$each.forEach(function(e){null!=l&&(e[l]=t),null!=c&&(e[c]=t)}):(null!=l&&(e.$push[u][l]=t),null!=c&&(e.$push[u][c]=t)))}if(null!=e.$set){var d=Object.keys(e.$set),y=!0,v=!1,_=void 0;try{for(var m,g=d[Symbol.iterator]();!(y=(m=g.next()).done);y=!0){u=m.value;var b=n(u);if(h=r.path(b)){for(var w=[],O=b.split("."),S=O.length-1;S>0;--S){var A=r.path(O.slice(0,S).join("."));null!=A&&(A.$isMongooseDocumentArray||A.$isSingleNested)&&w.push({parentPath:u.split(".").slice(0,S).join("."),parentSchemaType:A})}if(Array.isArray(e.$set[u])&&h.$isMongooseDocumentArray)o(e.$set[u],h,t);else if(e.$set[u]&&h.$isSingleNested)s(e.$set[u],h,t);else if(w.length>0){var E=!0,$=!1,j=void 0;try{for(var x,N=w[Symbol.iterator]();!(E=(x=N.next()).done);E=!0){var P=x.value,k=P.parentPath,T=P.parentSchemaType;if(f=T.schema.options.timestamps,c=i(f,"createdAt"),l=i(f,"updatedAt"),f&&null!=l)if(T.$isSingleNested)e.$set[k+"."+l]=t;else if(T.$isMongooseDocumentArray){var B=u.substr(k.length+1);if(/^\d+$/.test(B)){e.$set[k+"."+B][l]=t;continue}var C=B.indexOf(".");B=-1!==C?B.substr(0,C):B,e.$set[k+"."+B+"."+l]=t}}}catch(t){$=!0,j=t}finally{try{!E&&N.return&&N.return()}finally{if($)throw j}}}else if(null!=h.schema&&h.schema!=r&&e.$set[u]){if(f=h.schema.options.timestamps,c=i(f,"createdAt"),l=i(f,"updatedAt"),!f)continue;null!=l&&(e.$set[u][l]=t),null!=c&&(e.$set[u][c]=t)}}}}catch(t){v=!0,_=t}finally{try{!y&&g.return&&g.return()}finally{if(v)throw _}}}}else{var D=Object.keys(e).filter(function(t){return!t.startsWith("$")}),M=!0,R=!1,F=void 0;try{for(var I,L=D[Symbol.iterator]();!(M=(I=L.next()).done);M=!0){u=I.value;var U=n(u);(h=r.path(U))&&(Array.isArray(e[u])&&h.$isMongooseDocumentArray?o(e[u],h,t):null!=e[u]&&h.$isSingleNested&&s(e[u],h,t))}}catch(t){R=!0,F=t}finally{try{!M&&L.return&&L.return()}finally{if(R)throw F}}}}},function(t,e,r){"use strict";t.exports=function(t){return t.replace(/\.\$(\[[^\]]*\])?\./g,".0.").replace(/\.(\[[^\]]*\])?\$$/g,".0")}},function(t,e,r){"use strict";
/*!
 * ignore
 */var n=r(5);t.exports=
/*!
